            ...
            <div class="row mb-3">
              <div class="col-md-12 form-group d-flex align-items-center justify-content-end">
                <a class="btn min-wid-110 btn-warning grid-transform-link"
                  ...
                  data-href="{{ route('hinmoku.create') }}">新規追加</a>
              </div>
            </div>
            <div class="row">
              <div class="col-md-6">
                <div class="form-group row">
                  ...
                  <div class="col-sm-9">
                    <input type="text" name="{{ $form['name'] }}[hin_cd]" maxlength="8"
                      value="{{ data_get($form['data'], 'hin_cd', '') }}" class="form-control">
                  </div>
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group row">
                  ...
                  <div class="col-sm-9">
                    <input type="text" name="{{ $form['name'] }}[hin_nm]" maxlength="30"
                      value="{{ data_get($form['data'], 'hin_nm', '') }}" class="form-control">
                  </div>
                </div>
              </div>
            </div>
